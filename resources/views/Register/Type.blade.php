...
<div class="icon" onclick="toggleMenu()">
    ...
    <a href="{{url('')}}/">HOME</a>
    <a href="{{url('')}}/registration" style="color: yellow; background-color: black; font-weight: bolder; border: 2px solid white; border-radius: 29px;">Registration</a>

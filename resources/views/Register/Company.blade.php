...
<center><img src="{{asset('Images/Login/Logged_in.jpg')}}" style='background-color: white; height: 96px; width: 95px; border-radius: 59px;'></center>
                <p>
                <input type="text" id="Enrollment_No" class="fields" placeholder="Enter Your CIN *" name="CIN" required /><br><br>
                <input type="text" id="name" class="fields" placeholder="Enter Company Name *" name="name" required><br><br>
                <input type="email" name="email" id="email" placeholder="Enter Your Email *" class="fields" required><br><br>

                <select name="industry" id="course" class="fields" required>
                    <option selected>Select Industry</option>
                    <option value="IT">IT</option>
                    <option value="Business">Business</option>
                </select><br><br>
            
            <textarea name="location" id="" cols="32" rows="5" style="resize: none;" placeholder="Enter Company Headquarter's Address*"></textarea><br><br>
...
function Speech(){
  ...
  message.text="Thank you" + <?php echo json_encode($Name); ?> + "for registering yourself on N.J. Sonocha Management and Technical Institute's Placement Cell.";
...
function Speech(){
  ...
  // Set the text to be spoken
  message.text="Company Registration";

...
<center><img src="{{asset('Images/Login/Logged_in.jpg')}}" style='background-color: white; height: 96px; width: 95px; border-radius: 59px;'></center>
                <p>
                <input type="text" id="Enrollment_No" class="fields" value="{{$StudentId}}"><br><br>
                <input type="text" id="name" class="fields" value="{{$Student->Name}}" required><br><br>
                <select name="course" id="course" class="fields" required>
                    <option selected>{{$Student->Program}}</option>
                </select><br><br>
            <input type="Number" class="fields" value="{{$Student->Mobile}}" required><br><br>
            
  <input type="email" class="fields" value="{{$Student->Email}}" required><br><br>
...
function Speech(){
  ...
  message.text="Applicant Profile";

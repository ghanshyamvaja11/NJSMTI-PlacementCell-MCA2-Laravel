    ...
    <center>
        <h1 style="color: white; background: blue; border-radius: 29px; font-size: 24.9px;">Recieved Job Applications</h1>
            ...
            <th>{{$application->ApplicationId}}</th>
                ...
                <th>{{date("F j, Y", strtotime($application->Date))}}</th>
                ...
                <th><a href="{{url('')}}/company/jobposting/approve/{{$application->ApplicationId}}"><button style="color: white; background: green; cursor: pointer; border-radius: 19.5px;" class="btndlt">Approve</button></a></th>

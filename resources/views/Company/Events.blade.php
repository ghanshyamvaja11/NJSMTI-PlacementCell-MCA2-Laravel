...
<div class="navbar">
    ...
    <a href="{{url('')}}/company/events" style="color: white; background-color: red; font-weight: bolder; border: 2px solid white; border-radius: 24.9px;">Events</a>
</div>
</section>

<main>
    <center><h1 style="color: white; background: blue; border-radius: 29px; font-size: 24.9px;">Events</h1></center>
    @if (count($events)==0)
    <center><h4 style='color: blue;'>Events are not organized yet.</h4></center>
    @else
    <center>
        <h1 style="color: white; background: blue; border-radius: 29px; font-size: 29.29px;">Available Events</h1>
        <table>
            <tr>
            ...
            <th>{{$event->EventId}}</th>
                ...
                <th><a href="{{url('')}}/company/events/view/{{$event->EventId}}"><button style="color: white; background: green; cursor: pointer; border-radius: 19

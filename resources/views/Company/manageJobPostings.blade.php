...
<div class="navbar">
    ...
    <a href="{{url('')}}/company/managejobpostings" style="color: white; background-color: red; font-weight: bolder; border: 2px solid white; border-radius: 29.9px;">Manage Jobs</a>
...
<main>
   <center><h1 style="color: white; background: blue; border-radius: 29px; font-size: 24.9px;">Manage job Postings</h1></center>
    @if ($jobs->isEmpty())
...
function Speech(){
  ...
  // Set the text to be spoken
  message.text="Manage job Posting.";

...
class Register_Login extends Controller
{
     public function StudentRegister(Request $request){
        ...
        $data = Students::where('StudentId', $request->Enrollment_No)->exists();
        if($data){
        ...
        if($table->save()){
            ...
            mail($Email, 'Registraction Confirmation', $success);
    ...
    public function CompanyRegister(Request $request){
        ...
        $data = Companies::where('CompanyId', $request->CIN)->exists();
        if($data){
    ...
    public function loginWithOtp(Request $request){
        ...
        if($UserType == "Administrator"){
            ...
            if($data){
                ...
                if(mail($data['Email'], 'Login with OTP', $OTPMessage)){
                    session(['UserType' => $request->Login_type]);
        session(['UserId' => $request->Username]);
        session(['Email' => $data['Email']]);
    ...
    public function forgotPassword(Request $request){
        ...
        if($UserType == "Administrator"){
            ...
            if($data){
                ...
                if(mail($data['Email'], 'Forgot Password', $OTPMessage)){
                    session(['UserType' => $request->Login_type]);
        session(['UserId' => $request->Username]);
        session(['Email' => $data['Email']]);
    ...
    public function createNewPassword(Request $request){
        ...
        if($UserType == "Administrator"){
            ...
            if($data){
                ...
                if(mail($data['Email'], 'Password is Changed', $OTPMessage)){
                    Session::flush();

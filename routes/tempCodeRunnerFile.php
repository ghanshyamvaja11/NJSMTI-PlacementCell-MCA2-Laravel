...
Route::get('/forgotpassword/keyvarification', function(){
    return view('Login.Key_Verification');
});
...
Route::get('/administrator/event/create', function(){
    $events = Events::all();
    return view('Administrator.Event')->with(compact('events'));
});
Route::post('/administrator/event/create', [AdministratorController::class, 'Event']);
Route::get('/administrator/events/delete/{EventId}', [AdministratorController::class, 'EventDelete']);
...
// Route::get('/student/changeemail', function(){
//     return view('Student.Change Email');;
// });
// Route::post('/student/changeemail', [StudentController::class, 'ChangeEmail']);

// Route::get('/student/changepassword', function(){
//     return view('Student.Change Password');
// });
// Route::post('/student/changepassword', [StudentController::class, 'ChangePassword']);

Route::get('/student/uploadresume', function(){
    return view('Student.upload resume');
});
...
Route::post('/student/uploadresume',[StudentController::class, 'uploadresume']);
...
Route::get('/student/events/view/{$EventId}', function($EventId){
    ...
    return view('Student.Event Information')->with(compact('events'));
});
...
// Route::get('/company/changeemail', function(){
//     return view('Company.Change Email');;
// });
// Route::post('/company/changeemail', [CompanyController::class, 'ChangeEmail']);

// Route::get('/company/changepassword', function(){
...
Route::get('/company/jobposting/show/{StudentId}', function($StudentId){
    ...
    return view('Company.Applicant Profile')->with(compact('Student'));
});
